...
<div class="container content-section">
    <p class="lead">I am a Lecturer at <strong>SZABIST University</strong>, a data scientist, and an AI researcher passionate about understanding the human mind through language, computational biomarkers, and interpretable machine learning. My work explores how speech and linguistic patterns can reveal insights into cognition, behavior, and neurological health.</p>
    <p class="lead">At the RADAR Center, <strong><a href="https://www.muet.edu.pk/" target="_blank">Mehran University of Engineering and Technology</a></strong>, I work with complex research and institutional data, develop user-focused data systems, and support projects that enhance research visibility and university rankings. My recent research has focused on using explainable AI (XAI) techniques like LIME and SHAP to analyze speech-based linguistic features for early screening of Alzheimer's Disease, presented at INTERSPEECH 2024.</p>
    <p class="lead">With expertise in Python, NLP, data analysis, and web development, I've contributed to interdisciplinary research and received recognition in national-level programming and ICT competitions. I've also co-authored a book chapter on AI in healthcare.</p>
    <p class="lead">I'm driven by the idea that AI and data science should be transparent, human-centered, and socially impactful. I'm always open to connecting with researchers, practitioners, and collaborators who share this vision. You can contact me via email or LinkedIn.</p>
</div>
